 ...
 */
package com.alilitech.mybatis.jpa.criteria.expression.operator.like;
 ...
 * @since 1.1
 */
public class NotFreeLikeExpression<T> extends OperatorExpression<T> {

    public NotFreeLikeExpression() {
        this.argsQuantity = 1;
    }
